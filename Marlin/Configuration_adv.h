 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 5     //4// Degrees Celsius
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  35               //30// Seconds
...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_MIN_TRIGGER   185     // (°C) Minimum temperature to enable hotend protection
 ...
 */
#define E0_AUTO_FAN_PIN PA8 //% (Fan 0) Must Comment out Pin in Common.h file for this to work
// #define E1_AUTO_FAN_PIN -1 //Changed to reserv mem
...
// #define CHAMBER_AUTO_FAN_TEMPERATURE 30 //Changed to reserv mem
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY  //%
    ...
    #define POWER_LOSS_MIN_Z_CHANGE 0.1 // (mm) Minimum Z change before saving power-loss data //% 0.05 default
...
#define ADVANCED_PAUSE_FEATURE  //%
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      6  // (mm) The length of filament for a complete unload. //%
 ...
 */
   ...
   */
    ...
    // #define STEALTHCHOP_I // disabled for mem saveing
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //% default is 12v
  ...
  // #define X2_HYBRID_THRESHOLD    100 //disabeld for mem savings
...
#define FREEZE_FEATURE //%
  ...
  #define FREEZE_PIN 41   // Override the default (KILL) pin here //% Guessed at pin, left at defaut
